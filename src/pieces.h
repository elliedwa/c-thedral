...
static const enum piece PIECES_BY_SHAPE[NUM_PIECE_SHAPES][4] = {
        [SHAPE_TAVERN] = {LIGHT_TAVERN_1, LIGHT_TAVERN_2, DARK_TAVERN_1, DARK_TAVERN_2},
        [SHAPE_STABLE] = {LIGHT_STABLE_1, LIGHT_STABLE_2, DARK_STABLE_1, DARK_STABLE_2},
